      ...
      {ready && (
        <>
          ...
          <div className=" !relative hidden lg:block w-[1200px] h-[600px] mx-auto">
            ...
            <Link
              href="/contact-us"
              className="absolute uppercase top-[45%] right-[32%] bg-[#fff] text-[#14BDC6] text-3xl font-semibold p-7 px-32 underline rounded-xl  hover:text-[#fff] hover:bg-[#14BDC6] border-2 border-[#14BDC6] transition-all duration-200"
            >
              {t("contact_us")}
            </Link>
            <Link
          ...
          <Image
            ...
            <Link
              href="/contact-us"
              className="absolute uppercase top-[48%] right-[31%] bg-[#fff] text-[#14BDC6] text-sm font-semibold p-1 px-4 rounded-xl underline hover:text-[#fff] hover:bg-[#14BDC6] border-2 border-[#14BDC6] transition-all duration-200"
            >
              {t("contact_us")}
            </Link>
            <Link
